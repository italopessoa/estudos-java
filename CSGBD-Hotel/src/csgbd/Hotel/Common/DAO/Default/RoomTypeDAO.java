...
public class RoomTypeDAO implements IDAO<RoomType> {
    ...
    @Override
    public void Save(RoomType object)throws SQLException  {
        RoomType roomType;
    ...
    @Override
    public void Delete(RoomType object) throws SQLException {
        RoomType roomType;
        if (object.getClass().equals(RoomType.class)) {
            roomType = (RoomType) object;
        } else {
    ...
    @Override
    public ArrayList<RoomType> SelectAll() throws SQLException {
